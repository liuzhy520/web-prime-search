...
mcp = FastMCP(
    "web-prime-search",
    instructions="Multi-engine search tool with priority routing across X, Google, Douyin, and Baidu",
)
...
async def web_search(
    ...
    Args:
        ...
        engines: Optional list of engines to use. Defaults to all in priority order: x, google, douyin, baidu
